    ...
    <Card className="shadow-2xl border-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl overflow-hidden max-h-[calc(100vh-2rem)] lg:max-h-none">
      ...
      <CardContent className="space-y-4 px-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 gap-2 sm:gap-3">
          <Button
            variant="outline"
            className="h-12 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 border-slate-200 dark:border-slate-700 transition-all duration-200 hover:shadow-lg hover:scale-[1.02] hover:border-blue-300 gap-2"
          ...
          <Button
            variant="outline"
            className="h-12 bg-white dark:bg-slate-800 hover:bg-slate-900 hover:text-white dark:hover:bg-white dark:hover:text-slate-900 border-slate-200 dark:border-slate-700 transition-all duration-200 hover:shadow-lg hover:scale-[1.02] gap-2"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground group-focus-within:text-indigo-500 transition-colors" />
              <Input
                id="email"
                type="email"
                ...
                className="pl-10 h-12 bg-slate-50/50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all rounded-xl"
                required
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-xs text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 font-medium transition-colors hover:underline"
              >
                Forgot password?
              </Link>
            </div>
            <div className="relative group">
              <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground group-focus-within:text-indigo-500 transition-colors" />
              <Input
                id="password"
                ...
                className="pl-10 pr-10 h-12 bg-slate-50/50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all rounded-xl"
                required
              />
              <button
                type="button"
      ...
      <CardFooter className="justify-center pb-4 lg:pb-6 pt-2">
